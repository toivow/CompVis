        ...
        if not ret_val:
            ...
            if len(p0) <= 10:
                ...
                if len(faces) != 0:
                    ...
                    # Use this to make the box a little bit smaller
                    crop = 4
                    x1 = faces[0, 0] + crop
                    y1 = faces[0, 1] + crop
                    width = faces[0, 2] - crop
                    height = faces[0, 3] - crop
                    roi_gray = gray[x1:x1+width, y1:y1+height]
                    ##-your-code-ends-here-##
