...
pic_hom = np.hstack((ABCDEFGH_w, np.ones((ABCDEFGH_w.shape[0], 1))))

projected_1 = (P1t @ pic_hom.T).T
projected_2 = (P2t @ pic_hom.T).T

cx1 = projected_1[:, 0]/projected_1[:, -1]
cy1 = projected_1[:, 1]/projected_1[:, -1]
cx2 = projected_2[:, 0]//projected_2[:, -1]
cy2 = projected_2[:, 1]//projected_2[:, -1]
...
##-your-code-starts-here-##
Xc = np.hstack((Xc.T, np.ones((Xc.shape[1], 1))))

projected_1 = (P1 @ Xc.T).T
projected_2 = (P2 @ Xc.T).T

pcx1 = projected_1[:, 0]/projected_1[:, -1]
pcy1 = projected_1[:, 1]/projected_1[:, -1]
pcx2 = projected_2[:, 0]//projected_2[:, -1]
pcy2 = projected_2[:, 1]//projected_2[:, -1]
##-your-code-starts-here-##
